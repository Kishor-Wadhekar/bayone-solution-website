...
document.addEventListener("DOMContentLoaded", function () {
    ...
    links.forEach(function (link) {
        if (
            link.hostname &&
            !link.hostname.includes(window.location.hostname)
        ) {
    ...
    window.addEventListener("load", function () {
        const websiteLoader = document.querySelector("#websiteLoader");
    ...
    /* 9. Future Works Link */
    const futureWorksLink = document.querySelector(".future-works-link");
    ...
    if (futureWorksLink) {
        ...
        futureWorksLink.href = pageLinks[currentPage] || "#";
    }
    ...
    /* 11. Back To Top + Scroll Progress */
